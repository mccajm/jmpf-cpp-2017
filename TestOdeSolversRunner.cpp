...
CxxTest::StaticSuiteDescription suiteDescription_TestOdeSolvers( "TestOdeSolvers.hpp", 48, "TestOdeSolvers", suite_TestOdeSolvers, Tests_TestOdeSolvers );

static class TestDescription_suite_TestOdeSolvers_TestSomeExamples : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_TestOdeSolvers_TestSomeExamples() : CxxTest::RealTestDescription( Tests_TestOdeSolvers, suiteDescription_TestOdeSolvers, 72, "TestSomeExamples" ) {}
...
public:
 TestDescription_suite_TestOdeSolvers_TestAbstractClassMethods() : CxxTest::RealTestDescription( Tests_TestOdeSolvers, suiteDescription_TestOdeSolvers, 98, "TestAbstractClassMethods" ) {}
...
public:
 TestDescription_suite_TestOdeSolvers_TestDecoupledForwardEuler() : CxxTest::RealTestDescription( Tests_TestOdeSolvers, suiteDescription_TestOdeSolvers, 198, "TestDecoupledForwardEuler" ) {}
...
public:
 TestDescription_suite_TestOdeSolvers_TestSimpleCircle() : CxxTest::RealTestDescription( Tests_TestOdeSolvers, suiteDescription_TestOdeSolvers, 278, "TestSimpleCircle" ) {}
...
public:
 TestDescription_suite_TestOdeSolvers_TestErrorofSolver() : CxxTest::RealTestDescription( Tests_TestOdeSolvers, suiteDescription_TestOdeSolvers, 315, "TestErrorofSolver" ) {}
